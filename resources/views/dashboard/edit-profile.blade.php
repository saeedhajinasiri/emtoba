    ...
    <div class="container">
            ...
            <div class="col-md-12">
                <div id="toc">
                    <ul class="nav nav-list well">
                        <li class="toc-h3 toc-active"><a href="#toc0">Basic user information</a></li>
                        <li class="toc-h3"><a href="#toc1">Change password</a></li>
                        <li class="toc-h3"><a href="#toc2">Change email address</a></li>
                        <li class="toc-h3"><a href="#toc3">Verification</a></li>
                        <li class="toc-h3"><a href="#toc4">Security</a></li>
                        <li class="toc-h3"><a href="#toc5">Real name</a></li>
                        <li class="toc-h3"><a href="#toc6">Apps</a></li>
                        <li class="toc-h3"><a href="#toc7">Premium service receipts</a></li>
                        <li class="toc-h3"><a href="#toc8">Personal data</a></li>
                        <li class="toc-h3"><a href="#toc9">Account deletion</a></li>
                    </ul>
                </div>
            </div>
        ...
        <span>
            <i class="fa fa-exclamation"></i>&nbsp;
                    ...
                    Your email verification mail has expired.

                <a href="/accounts/profile-edit/change-email/" class="btn btn-default profile-verified-info">Set up email</a>
        ...
        <span>
            <i class="fa fa-exclamation"></i>&nbsp;
                ...
                <a class="btn btn-default profile-verified-info" href="/accounts/sms_activate/">Verify phone number</a>
        ...
        <span>
            <i class="fa fa-exclamation"></i>&nbsp;
            You have not set a real name to your account yet.
            <a class="btn btn-default profile-verified-info" href="/accounts/real_name/">Set real name</a>
        </span>
                </div>
            </div>
            ...
            <div class="offset col-md-11">
                ...
                <p>
                    ...
                    saeed.hajinasiri@gmail.com (Unverified)
                </p>


                <form action="/accounts/profile/" method="POST" class="edit-userprofile-form"><input name="csrfmiddlewaretoken" value="jLQ4efDd7KArGHzB0dCo4R5fWW21zMvT" type="hidden">


                    <div id="div_id_timezone" class="form-group"><label for="id_timezone" class="control-label ">
                            Timezone
                        </label>
                        <div class="controls "><select class="select form-control" id="id_timezone" name="timezone">
                                ...
                                <option value="America/Campo_Grande">(GMT-0400) America/Campo_Grande</option>
                                ...
                                <option value="Asia/Tehran">(GMT+0430) Asia/Tehran</option>
                                ...
                                <option value="Australia/Currie">(GMT+1000) Australia/Currie</option>
                                ...
                                <option value="Pacific/Apia">(GMT+1300) Pacific/Apia</option>
                    ...
                    <div class="form-group">
                        <div id="div_id_show_me_as_identity_verifier" class="checkbox"><label for="id_show_me_as_identity_verifier" class=""> <input checked="checked" class="checkboxinput" id="id_show_me_as_identity_verifier" name="show_me_as_identity_verifier" type="checkbox">
                                Show me as real name verifier to others


                                <p id="hint_id_show_me_as_identity_verifier" class="help-block">Your username is shown when people make new trades with your old trading partners.</p></label></div>
                    </div>
                    <div class="form-group">
                        <div id="div_id_disable_sensitive_emails" class="checkbox"><label for="id_disable_sensitive_emails" class=""> <input class="checkboxinput" id="id_disable_sensitive_emails" name="disable_sensitive_emails" type="checkbox">
                                Disable sensitive information from email notifications


                                <p id="hint_id_disable_sensitive_emails" class="help-block">The e-mails will just ask you to log in to the site, where the actual notifications will be.</p></label></div>
                    </div>
                    <div class="form-group">
                        <div id="div_id_enable_web_notifications" class="checkbox"><label for="id_enable_web_notifications" class=""> <input class="checkboxinput" id="id_enable_web_notifications" name="enable_web_notifications" type="checkbox">
                                Enable web notifications


                                <p id="hint_id_enable_web_notifications" class="help-block">You will get external notifications outside the browser window.</p></label></div>
                    </div>
                    <div class="form-group">
                        <div id="div_id_holiday_selling" class="checkbox"><label for="id_holiday_selling" class=""> <input class="checkboxinput" id="id_holiday_selling" name="holiday_selling" type="checkbox">
                                Selling vacation


                                <p id="hint_id_holiday_selling" class="help-block">Disable all your advertisements for sale temporarily</p></label></div>
                    </div>
                    <div class="form-group">
                        <div id="div_id_holiday_buying" class="checkbox"><label for="id_holiday_buying" class=""> <input class="checkboxinput" id="id_holiday_buying" name="holiday_buying" type="checkbox">
                                Buying vacation


                                <p id="hint_id_holiday_buying" class="help-block">Disable all your advertisements for purchase temporarily.</p></label></div>
                    </div>
                    <div class="form-group">
                        <div id="div_id_sms_send_contact_notifications" class="checkbox"><label for="id_sms_send_contact_notifications" class=""> <input checked="checked" class="checkboxinput" id="id_sms_send_contact_notifications" name="sms_send_contact_notifications" type="checkbox">
                                Send SMS notifications for new trade contacts


                                <p id="hint_id_sms_send_contact_notifications" class="help-block">Send SMS notifications from new contact requests (price: free)</p></label></div>
                    </div>
                    <div class="form-group">
                        <div id="div_id_sms_send_escrow_notifications" class="checkbox"><label for="id_sms_send_escrow_notifications" class=""> <input class="checkboxinput" id="id_sms_send_escrow_notifications" name="sms_send_escrow_notifications" type="checkbox">
                                Send SMS notifications for new online payments


                                <p id="hint_id_sms_send_escrow_notifications" class="help-block">Send SMS notifications from new online payments in your advertisements (price: free)</p></label></div>
                    </div>
                    <div class="form-group">
                        <div id="div_id_sms_send_release_notifications" class="checkbox"><label for="id_sms_send_release_notifications" class=""> <input class="checkboxinput" id="id_sms_send_release_notifications" name="sms_send_release_notifications" type="checkbox">
                                Send SMS notifications for online escrow released


                                <p id="hint_id_sms_send_release_notifications" class="help-block">Send SMS notifications from new online escrow releases (price: free)</p></label></div>
                    </div>
                    <div id="div_id_introduction" class="form-group"><label for="id_introduction" class="control-label ">
                            Introduction
                        </label>
                        <div class="controls "><textarea class="textarea form-control" cols="40" id="id_introduction" name="introduction" rows="10"></textarea>
                            <p id="hint_id_introduction" class="help-block">Shown on your public profile. Plain text only, up to 200 characters.</p></div>
                    </div>
            ...
            <div class="offset col-md-11">
                ...
                <p>
                    <a href="/password_change/"><i class="fa fa-arrow-right"></i> Change password</a>
                </p>
                ...
                <p>
                    <a href="/accounts/profile-edit/change-email/"><i class="fa fa-arrow-right"></i> Change email address</a>
                </p>
                ...
                <p>
                    ...
                    <a href="/accounts/profile-edit/change-email/"><i class="fa fa-arrow-right"></i> Set up email</a>
                ...
                <p>
                    <a href="/accounts/sms_activate/"><i class="fa fa-arrow-right"></i> Verify phone number</a>
                </p>
                ...
                <p>
                    <a href="/accounts/identification/"><i class="fa fa-arrow-right"></i> Verify identity</a>
                </p>
                ...
                <p>
                    ...
                    <strong class="security-level-weak">weak</strong>

                </p>


                <a href="/accounts/security/">Edit security options</a>
                ...
                <p>
                    ...
                    Real name verification: <strong>0</strong> verifications

                </p>


                <p>
                    <a href="/accounts/real_name/"><i class="fa fa-arrow-right"></i> Your real name information</a>
                </p>
                ...
                <p>
                    ...
                    Third-party apps can do trades for you on LocalBitcoins with <a href="/api-docs/">LocalBitcoins API</a>.

                </p>


                <p>
                    You are not using any apps right now.
                </p>


                <p><a href="/accounts/profile-edit/change-pincode/"><i class="fa fa-arrow-right"></i> Set and change App PIN code</a></p>

                <p><a href="/accounts/api/"><i class="fa fa-arrow-right"></i> Manage apps</a></p>
                ...
                <p>
                    <a href="/receipts/">View your receipts for LocalBitcoins.com services here</a>
                </p>
                ...
                <p>
                    ...
                    <strong>Note:</strong>
                    These are not the receipts from your transactions, but the receipts from the services you have bought from localbitcoins.com, for tax purposes.
                    You can find your trade receipts under <a href="/ads">Dashboard</a>, Closed contacts.
                ...
                <h3>Personal data</h3>
                <p>
                    <a href="/accounts/profile-edit/personal-data/"><i class="fa fa-arrow-right"></i> Show personal data</a>
                </p>

                <span id="toc9"></span>
                <h3>Account deletion</h3>
                <p>
                    <a href="/accounts/profile-edit/delete-account/"><i class="fa fa-arrow-right"></i> Delete your LocalBitcoins account</a>
                </p>
