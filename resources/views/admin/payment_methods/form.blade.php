    ...
    <div class="row">
            ...
            <div class="portlet">
                <div class="portlet-title">
                    ...
                    <div class="pull-left">
                        ...
                        <a href="{!! route('admin.payment_methods.index') !!}" class="btn btn-labeled btn-danger m-b-5">
            ...
            <div class="panel panel-bd lobidisable">
                <div class="panel-heading">
                    <div class="panel-title">
                        <h4>{{ trans('admin.payment_methods.info') }}</h4>
                    </div>
                </div>
        ...
        <div class="col-sm-12 col-md-4">
            <div class="panel panel-bd lobidisable">
                <div class="panel-heading">
                    <div class="panel-title">
                        <h4>{{ trans('admin.page.other_info') }}</h4>
                    </div>
                </div>
                <div class="panel-body">
                    {!! form_row($form->sell_risk) !!}
                    {!! form_row($form->buy_risk) !!}
                </div>
            </div>
        </div>
