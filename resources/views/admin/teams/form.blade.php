            ...
            <div class="portlet">
                <div class="portlet-title">
                    ...
                    <div class="pull-left">
                        ...
                        <a href="{!! route('admin.teams.index') !!}" class="btn btn-labeled btn-danger m-b-5">
        ...
        <div class="col-sm-12 col-md-4">
            <div class="panel panel-bd lobidisable">
                ...
                <div class="panel-body">
                    ...
                    @if(isset($item))
                        <img src="/images/team/{{ $item->image }}" alt="{{ $item->image }}" width="100%">
                    @endif
                </div>
            </div>
            <div class="panel panel-bd lobidisable">
