        ...
        <div class="col-lg-12">
            <div class="portlet">
                <div class="portlet-title">
                    ...
                    <div class="pull-left">
                        <a href="{{ route('admin.about.create') }}" class="btn btn-labeled btn-success m-b-5" type="button">
            ...
            <div class="panel panel-default lobidisable">
                ...
                <div class="panel-body">
                    <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                        ...
                        <tr>
                            <th>#</th>
                            <th> {{ trans('admin.about.title') }} </th>
                            <th> {{ trans('admin.about.createTime') }} </th>
                            <th> {{ trans('admin.about.actions') }} </th>
                        </tr>
                        </thead>
                        <tbody>
                        @forelse($items as $item)
                            <tr class="odd gradeX">
                                ...
                                <td class="center">
                                    {{ Form::open(['method' => 'DELETE', 'route' => ['admin.about.destroy', $item->id]]) }}
                                    <a href="{{ route('admin.about.edit', $item->id) }}" class="btn btn-info btn-sm" data-toggle="tooltip" data-placement="top" title="" data-original-title="Edit"><i class="fa fa-pencil" aria-hidden="true"></i></a>
