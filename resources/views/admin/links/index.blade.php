        ...
        <div class="col-lg-12">
            <div class="portlet">
                <div class="portlet-title">
                    ...
                    <div class="pull-left">
                        <a href="{{ route('admin.links.create') }}" class="btn btn-labeled btn-success m-b-5" type="button">
                        ...
                        @forelse($items as $item)
                            <tr class="odd gradeX">
                                ...
                                <td class="center">
                                    ...
                                    <a href="{{ route('admin.links.edit', $item->id) }}" class="btn btn-info btn-sm" data-toggle="tooltip" data-placement="top" title="" data-original-title="Edit"><i class="fa fa-pencil" aria-hidden="true"></i></a>
