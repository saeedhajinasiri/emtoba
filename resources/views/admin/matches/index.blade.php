                    ...
                    <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                        ...
                        @forelse($items as $item)
                            <tr class="odd gradeX @if(!$item->read) info @endif">
                                ...
                                <td class="center">
                                    {{ Form::open(['method' => 'DELETE', 'route' => ['admin.matches.destroy', $item->id]]) }}
                                    <a href="{{ route('admin.matches.edit', $item->id) }}" class="btn btn-info btn-sm" data-toggle="tooltip" data-placement="top" title="" data-original-title="Edit"><i class="fa fa-pencil" aria-hidden="true"></i></a>
