            ...
            <div class="portlet">
                <div class="portlet-title">
                    ...
                    <div class="pull-left">
                        ...
                        <a href="{!! route('admin.lessons.index') !!}" class="btn btn-labeled btn-danger m-b-5">
            ...
            <div class="panel panel-bd lobidisable">
                <div class="panel-heading">
                    <div class="panel-title">
                        <h4>{{ trans('admin.lessons.info') }}</h4>
                    </div>
                </div>
            ...
            <div class="panel panel-bd lobidisable">
                ...
                <div class="panel-body">
                    ...
                    @if(isset($item) && $item->file)
                        <a href="{{ $item->fileLink }}">Download File</a>
                    @endif
                </div>
            </div>
        </div>
