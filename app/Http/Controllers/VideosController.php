...
class VideosController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('site.videos.index', compact('items', 'settings'));
    }
    ...
    public function show($id, $slug = null)
    {
        ...
        $isLikedBefore = $item->likes()->where('user_ip', \Request::ip())->exists();
        ...
        $pageTitle = $item->title . ' | ' . $this->settings['site_title'];

        return view('site.news.show', compact('item', 'latestNews', 'sharerUrl', 'isLikedBefore', 'pageTitle'));
    }
